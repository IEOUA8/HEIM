...
export default function AdminLayout({ children }: LayoutProps<"/admin">) {
  return (
    <div className="flex min-h-screen flex-col bg-brand-ivory md:flex-row">
      ...
      <aside className="flex shrink-0 flex-col gap-6 bg-brand-forest px-5 py-6 md:w-60 print:hidden">
      ...
      <main className="flex-1 px-5 py-6 md:px-8 md:py-8 print:p-0">{children}</main>
    </div>
  );
}
